...
public class Utils extends BasePage{
    ...
    public static void selectVisibleText(By by, String data) {
        Select value = new Select(BasePage.driver.findElement(by));
...
//    }
    ...
    public Actions mouseOverHover(By by) {
        ...
        WebElement element = BasePage.driver.findElement(by);
    ...
    public static void emailWithTimeStamp(By by) {
        ...
        BasePage.driver.findElement(by).sendKeys("Test+" + timeStamp + "@home.com");
    }
